                    ...
                    <div style={{flex: 1, position: 'relative', overflow: 'hidden'}}>
                        {tabs.map(tab => (
                            <div key={tab.id}
                                ...
                                {tab.type === 'home' && (
                                    <div style={{padding: '80px 40px', textAlign: 'center', userSelect: 'none'}}>
                                        ...
                                        <div style={{
                                                ...
                                                >
                                                    <div style={{
                                                        ...
                                                        {fav.osPrettyName ? (
                                                            ...
                                                            <Server size={80} style={{opacity: 0.7}}/>
                                                        )}
                                                    </div>
                                                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%'}}>
                                                        <div style={{fontWeight: 'bold', fontSize: '1.2em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%'}}>
                                                            {fav.name || fav.host}
                                                        </div>
                                                        <div style={{opacity: 0.6, fontSize: '1em'}}>
                                                            ssh, {fav.user}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            >
                                                <div style={{
                                                    ...
                                                    <Plus size={64} style={{opacity: 0.5}}/>
                                                </div>
